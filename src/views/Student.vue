  ...
  export default {
    ...
    setup() {
      ...
      const fetchstudents = async () => {
        try {
          const response = await fetch("http://localhost:8081/project_67700420_vue/api_php/show_student.php", {
            method: "GET",
            headers: {
...
const deleteStudents = async (id) => {
  ...
  try {
    const response = await fetch("http://localhost:8081/project_67700420_vue/api_php/api_student.php", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      },
