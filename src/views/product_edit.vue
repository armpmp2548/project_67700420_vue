<template>
      ...
      <tbody>
        <tr v-for="product in products" :key="product.product_id">
          ...
          <td>
            <img
              v-if="product.image"
              :src="'http://localhost:8081/project_67700420_vue/api_php/uploads/' + product.image"
              width="100"
            />
          </td>
          <td>
  ...
  <div v-if="isEditMode && editForm.image">
    ...
    <img
      :src="'http://localhost:8081/project_67700420_vue/api_php/uploads/' + editForm.image"
      width="100"
    />
  </div>
</div>
...
export default {
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost:8081/project_67700420_vue/api_php/api_product.php");
